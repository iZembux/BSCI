...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			var sStdMenu = '<select class="select" size="1" '+sName+'>';
			var i, iLen;
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sEmptyTable": "No har registros encontrados",
			 ...
			 *    } );
			 */
			"sInfo": "Visualizando _START_ al _END_ de _TOTAL_ registros",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Visualizando 0 al 0 de 0 registros",

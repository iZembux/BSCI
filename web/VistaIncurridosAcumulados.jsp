<%-- 
    Document   : VistaIncurridosAcumulados
    Created on : 29/01/2018, 02:03:47 PM
    Author     : Guadalupe
--%>
        ...
        <section id="main" class="p-relative" role="main">
            ...
            <section id="content" class="container">
                ...
                <!-- Breadcrumb -->
                 ...
                 <p style="text-align: center;"><FONT SIZE=6>Incurridos con Acumulado</FONT>
                 </p>
        ...
        <div class="row">
            ...
            <table class=" col-md-11">
                <tr>
                    ...
                    <td>
                        <select class="select" name="selectUnidadNegocio" id="selectUnidadNegocio" onchange="mostrarIncurrido('filtroIncurridosCap.jsp', 'selectUnidadNegocio', 'selectDepartamento', 'selectArea', 'selectMes', 'selectAnio', 'mainTableAreaIncurridos');">
                    ...
                    <td>
                        <select class="select" name="selectDepartamento" id="selectDepartamento" onchange="mostrarIncurrido('filtroIncurridosCap.jsp', 'selectUnidadNegocio', 'selectDepartamento', 'selectArea', 'selectMes', 'selectAnio', 'mainTableAreaIncurridos');">
                    ...
                    <td class=" col-md-3" style=" text-align: right">
                        Seleccione una Area:
                    <td>
                        <select class="select" name="selectArea" id="selectArea" onchange="mostrarIncurrido('filtroIncurridosCap.jsp', 'selectUnidadNegocio', 'selectDepartamento', 'selectArea', 'selectMes', 'selectAnio', 'mainTableAreaIncurridos');">
                            <option value="all">Todas</option>
                ...
                <tr>
                    ...
                    <td>
                        <select class="select" name="selectMes" id="selectMes" onchange="mostrarIncurrido('filtroIncurridosCap.jsp', 'selectUnidadNegocio', 'selectDepartamento', 'selectArea', 'selectMes', 'selectAnio', 'mainTableAreaIncurridos');">
                    ...
                    <td>
                        <select class="select" name="selectAnio" id="selectAnio" onchange="mostrarIncurrido('filtroIncurridosCap.jsp', 'selectUnidadNegocio', 'selectDepartamento', 'selectArea', 'selectMes', 'selectAnio', 'mainTableAreaIncurridos');">
                            <%
                ...
                <table class="tile table table-bordered table-striped" style=" width: 98%; text-align: center;">
                    <thead>
                        <tr>
                            ...
                            <td class="col-md-2">Acumulado a Enero</td>
                ...
                <div id="areaDetalle" style=" width: 1300px; height: 200px; overflow-y: scroll;">
                    <table class="tile table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            %>
                            <tr>
                                <td class="col-md-2"><% out.print(departamento);%></td>
                                ...
                                <td class="col-md-2"><input type="number" name="eneroAcumulado<%=Idincurrido%>" id="eneroAcumulado<%=Idincurrido%>" 
                                                                       value="<% out.print(EneroAcumulado);%>" class="form-control"></td>
                                <td class="col-md-2">
                                    <a href="#"><img src="img/save.png" width="30px" height="30px" onclick="actualizarIncurridoEneroAcumulado('actualizarIncurridosCap.jsp?accion=2&usuario=Sistemas&unidadNegocio=<%=unidadNegocio%>&identificaIndicador=<%=identificaIndicador%>', '<% out.print(Idincurrido);%>', '<% out.print(Anio);%>', 'enero<%=Idincurrido%>', 'eneroAcumulado<%=Idincurrido%>', 'actulizaIncurrido');"/></a>
                                </td>

<%-- 
    Document   : IndicadorC_2
    Created on : 29/01/2018, 12:25:28 PM
    Author     : Guadalupe
--%>
        ...
        <div class="clearfix"></div>
            ...
            <aside id="sidebar">
                ...
                <!-- Side Menu -->
                 <ul class="list-unstyled side-menu">
                    <li class="active">
                        <a href="ReportesG.jsp"><i class="fa fa-folder-open-o fa-2x"></i>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="list-unstyled menu-item">
                            ...
                            <li><a href="IndicadorC_2.jsp?empresa=Lerma">Lerma</a></li>
            ...
            <section id="content" class="container">
                ...
                <div class="block-area" id="custom-select">
                    ...
                    <img src="img/agencias/<%=empresa%>.png" class=" center-block">
                    <br/>
            ...
            <div class="table-responsive">
                        ...
                        <table class="tile table table-bordered table-striped" id="listaFacturas">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center;">Objetivo Global</th>
                                    <th style="text-align: center;">Puntos Optimos</th>
                        ...
                        <tr>                            
                            <td></td>
                            <td><% out.print(departamento);%></td>
                            <td><% out.print(area);%></td>
                            <td><% out.print(Indicador);%></td>

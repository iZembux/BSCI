<%-- 
    Document   : filtroIncurridos_2
    Created on : 29/01/2018, 03:44:35 PM
    Author     : Guadalupe
--%>
...
<table class="tile table table-bordered table-striped" style=" text-align: center">
    <thead>
        <tr>
            ...
            <td class=" col-md-4">Incurrido</td>
    ...
    <table class="tile table table-bordered table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class=" col-md-2"><% out.print(area);%></td>
                <td class=" col-md-4"><% out.print(Incurrido);%></td>
                ...
                <td class=" col-md-2">
                    ...
                    <a href="#"><img src="img/save.png" width="30px" height="30px" onclick="actualizarIncurridoCualquierMes('actualizarIncurridos.jsp?accion=2&usuario=Sistemas&unidadNegocio=<%=unidadNegocio%>&identificaIndicador=<%=identificaIndicador%>', '<% out.print(Idincurrido);%>', '<% out.print(Anio);%>', '<%=mesMostrar%>', '<%=mesMostrar%><%=Idincurrido%>', 'actulizaIncurrido');"/></a>
                </td>
            </tr>
            <%
                    }

<%-- 
    Document   : BSCIAnual
    Created on : 29/01/2018, 11:51:17 AM
    Author     : Guadalupe
--%>
...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    ...
    <body>
        ...
        balance reportebalance = new balance();
        ArrayList<balance> arrayBalanceAcum = new ArrayList<balance>();  
       ...
       %>
        ...
        double totalObtenido2 = 0, totalOptimo2 = 0, porcentajeExito2=0.0;
                            ...
                            String idDepartamento= arrayBalance.get(i).getBal_identificaDepartamento();
                             if (idDepartamento.equals("BAL_DE004")){
                                ...
                                totalOptimo4 += puntosOptimos; 
                                 ...
                                 if(Indicador.equals("Dias Inventario unidades seminuevas") || 
                     ...
                     for (int tabla = 0; tabla < arrayDepartamentos.size(); tabla++) {
                        ...
                        for (int i = 0; i < arrayBalance.size(); i++) {
                            ...
                            if (idDepartamento.equals("BAL_DE005")){
                                ...
                                totalObtenido5 += puntosObtenidos;
                                totalOptimo5 += puntosOptimos;
                                if(Indicador.equals("Posicion en Ranking Nacional de Ventas Flotillas")){
                                   ObjAcumulado= objAnual;  
                                }
                %> 
                    <tr>
                         ...
                         for (int i = 0; i < arrayBalance.size(); i++) {
                            String idDepartamento= arrayBalance.get(i).getBal_identificaDepartamento();
                             if (idDepartamento.equals("BAL_DE006")){
                                ...
                                if(Indicador.equals("Penetracion Hyundai Finance")){  
                                  ObjAcumulado= objAnual;   
                                }
                %> 
                    <tr>
                     ...
                     for (int tabla = 0; tabla < arrayDepartamentos.size(); tabla++) {
                        ...
                        for (int i = 0; i < arrayBalance.size(); i++) {
                            ...
                            if (idDepartamento.equals("BAL_DE007")){
                                ...
                                if(unidadNegocio.equals("PuertaSantaFe") && Indicador.equals("Venta al Taller de Servicio")){
                                    ObjAcumulado= objAnual;   
                                }else if(unidadNegocio.equals("PuertaSantafe") && Indicador.equals("Utilidad Bruta")){
                                    ObjAcumulado= objAnual;   
                                } 
                %> 
                    <tr>
                        ...
                        for (int i = 0; i < arrayBalance.size(); i++) {
                            ...
                            if (idDepartamento.equals("BAL_DE008")){
                                ...
                                totalOptimo8 += puntosOptimos;
                                 ...
                                 if(Indicador.equals("Entrega Oportuna de Estados Financieros") || Indicador.equals("Dias Cartera Autos Nuevos") || Indicador.equals("Dias Cartera Incentivos Financiera") || 
                                        Indicador.equals("Cumplimiento de Obligaciones Fiscales") || Indicador.equals("BSC Planta") || Indicador.equals("Satisfaccion de Colaboradores") || 
            ...
            <BR/>
            <%System.out.println("=======================Finaliza BSCI Anual =====================");%>

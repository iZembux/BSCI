<%-- 
    Document   : GenerarResultadoBSC
    Created on : 29/01/2018, 12:12:52 PM
    Author     : Guadalupe
--%>
...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="list-unstyled menu-item">
                           <li><a href="IndicadorC.jsp?empresa=Continental">Continental</a></li>
                            ...
                            <li><a href="IndicadorC.jsp?empresa=Alfa-Auto">Alfa-Autopolanco</a></li>
                            <li><a href="IndicadorC.jsp?empresa=Mitsu-Auto">Mitsu-Autopolanco</a></li>
                        </ul>
                    </li>
                    <li class="active">
 ...
 <form action="ResultadosBSCI.jsp" target="_blank" method="post"> 
                     <div class="row">

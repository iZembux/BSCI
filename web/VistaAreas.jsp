<%-- 
    Document   : VistaAreas
    Created on : 29/01/2018, 02:01:57 PM
    Author     : Guadalupe
--%>

<%@page import="modelo.areas, modelo.procesosFecha, java.util.ArrayList;"%>
        ...
        <section id="main" class="p-relative" role="main">
            ...
            <section id="content" class="container">
                ...
                <img src="img/Continental.PNG" class="img-responsive center-block">
                    <br/>
                <p style="text-align: center;"><FONT SIZE=6>Areas</FONT>
                 </p>
                  <!-- DATOS-->
            ...
            %>
                    ...
                    <div class="table-responsive overflow">
                        ...
                        %>
                                ...
                                <tr>
                                    <td width="300px" height="20px" style=" text-align: center"><% out.print(Idarea);%></td>
                                    <td width="300px" height="20px"><% out.print(Area);%></td>
                                    <td width="300px" height="20px" style=" text-align: center"><% out.print(Activo);%></td>
                                </tr>
                                 <%
                                }

<%-- 
    Document   : ReportesG_Anual
    Created on : 29/01/2018, 01:20:25 PM
    Author     : Guadalupe
--%>
...
<%System.out.println("============Generar Reporte BSCI================");
    ...
    System.out.println("nombreee es: " +nombre);
    System.out.println("Contraseña es : "+pass); 
...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
 ...
 <form action="BSCIAnual.jsp" target="_blank" method="post"> 
                     <div class="row">
                        <div class="col-md-3 m-b-15">
                            <label>Generar Reporte</label>
                            <select class="select" name="unidadNegocio">
                              <%// aqui van las validaciones para usuariossssss                    
                            if (objusr.consultausuarioint("Conti", nombre) == 1) { %>
                           ...
                           <% } %>
                             <%// aqui van las validaciones para usuariossssss                    
                              if (objusr.consultausuarioint("Mitsu", nombre) == 1) { %>
                            <option value="Mitsuautos">Mitsubishi</option>
                            <%}%>
                             <%// aqui van las validaciones para usuariossssss                    
                             if (objusr.consultausuarioint("fiat", nombre) == 1) { %>
                            <option value="Automodena">Fiat Metepec</option>
                            <%}%>
                             <%// aqui van las validaciones para usuariossssss                    
                             if (objusr.consultausuarioint("hyundai", nombre) == 1) { %>
                             <option value="KoreanMotors">Hyundai Metepec</option>    
                            <%}%>
                             <%// aqui van las validaciones para usuariossssss                    
                             if (objusr.consultausuarioint("patriotismo", nombre) == 1) { %>
                            <option value="HyundaiPatriotismo">Hyundai Patriotismo</option>       
                            <%}%>
                             <%// aqui van las validaciones para usuariossssss                    
                             if (objusr.consultausuarioint("hyundaisantafe", nombre) == 1) { %>
                             <option value="HyundaiSantaFe">Hyundai Santa Fe</option>    
                            <%}%>
                            <%// aqui van las validaciones para usuariossssss                    
                             if (objusr.consultausuarioint("autopolanco", nombre) == 1) { %>
                             <option value="Autopolanco">San Rafael CDFJR</option>   
                             <option value="AutopolancoChrysler">Autopolanco CDFJR</option>
                            <%}%>
                             <%// aqui van las validaciones para usuariossssss                    
                             if (objusr.consultausuarioint("fiatauto", nombre) == 1) { %>
                            ...
                            <%}%>
                             <%// aqui van las validaciones para usuariossssss                    
                             if (objusr.consultausuarioint("puertasantafe", nombre) == 1) { %> 

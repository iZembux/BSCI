<%-- 
    Document   : BSCI_3
    Created on : 29/01/2018, 11:57:34 AM
    Author     : Guadalupe
--%>
...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    ...
    <body>
        <!-- Tablas -->
        <br>
        <%  System.out.println("=====================Bienvenidos Balance 3=====================");
        utilMath objMath = new utilMath();
        DecimalFormat df = new DecimalFormat("#.0"); 
        double Poptimos=0.0, PoptimosH=0.0, PoptimosVN=0.0, PoptimosVS=0.0, PoptimosVF=0.0, PoptimosFI=0.0,PoptimosR=0.0,PoptimosAYF=0.0; 
        int anioReporte = 0;
        int mesReporte = 0;
       ...
       %>
                ...
                <table width="100%" style="border-collapse: collapse;"> 
                    ...
                    <tr>
                        <td bgcolor="#23350c" align="CENTER" style="font-weight: bold;  border: black 1px solid; font-family: Calibri"><font color="white" size="1">PUNTUACIÓN MÁXIMA</td></font>
                         <%
                              double resta=0.0, resta2=0.0, resta3=0.0, resta4=0.0, resta5=0.0, resta6=0.0, resta7=0.0, resta8=0.0, resta9=0.0;
        ...
        double optimoss=0.0, optimoss2=0.0, optimoss3=0.0, optimoss4=0.0,optimoss5=0.0,optimoss6=0.0,optimoss7=0.0,optimoss8=0.0; 
                 for (int tabla = 0; tabla < arrayDepartamentos.size(); tabla++) {
                    ...
                    puntosResumen[tabla][0]=arrayDepartamentos.get(tabla).getBal_departamento();
                        for (int i = 0; i < arrayBalance.size(); i++) {
                             double puntosObtenidos = arrayBalance.get(i).getBal_PuntosObtenidos();arrayBalance = generarReporte.genenrarBalanceXDepartamento(mesReporte, anioReporte, arrayDepartamentos.get(tabla).getBal_identificaDepartamento(), unidadNegocio);
                             puntosResumen[tabla][0]=arrayDepartamentos.get(tabla).getBal_departamento();
                          ...
                          //   String Indicador=arrayBalance.get(i).getBal_Indicador();  
                           ...
                           //  double incurridoCuatrimestre=arrayBalance.get(i).getBal_IncCuatrimestre();
                             ...
                             if (idDepartamento.equals("BAL_DE001")){ 
                                 ...
                                 if(Indicador.equals("CSI") && incurridoCuatrimestre==0 || Indicador.equals("CSI") && incurridoAcumulado==0 || Indicador.equals("CSI ") && incurridoCuatrimestre==0 || Indicador.equals("CSI ") && incurridoAcumulado==0){ 
                                     optimoss=optimoss+puntosOptimos;
                                 }else if(Indicador.equals("FFV") && incurridoCuatrimestre==0 || Indicador.equals("FFV") && incurridoAcumulado==0 || Indicador.equals("FFV ") && incurridoCuatrimestre==0 || Indicador.equals("FFV ") && incurridoAcumulado==0){ 
                                     optimoss=optimoss+puntosOptimos; 
                                 }else if(Indicador.equals("Indice de Satisfaccion de Empleados ") && incurridoCuatrimestre==0 || Indicador.equals("Índice de Satisfacción del Personal") && incurridoCuatrimestre==0 || Indicador.equals("Indice de Satisfaccion de Empleados") && incurridoCuatrimestre==0 || Indicador.equals("Indice de Satisfaccion del Personal") && incurridoCuatrimestre==0){
                                     optimoss=optimoss+puntosOptimos; 
                                 }else if(Indicador.equals("SSI") && incurridoCuatrimestre==0 || Indicador.equals("SSI") && incurridoAcumulado==0){
                                     optimoss=optimoss+puntosOptimos;  
                                 }else if(Indicador.equals("Cumplimiento al programa cuatrimestral de capacitación") && incurridoCuatrimestre==0 || 
	    Indicador.equals("Cumplimiento al programa cuatrimestral de capacitacion") && incurridoCuatrimestre==0){
                                     optimoss=optimoss+puntosOptimos;  
                                 }else if(Indicador.equals("Calificación DSC Planta") && incurridoCuatrimestre==0){
                                     optimoss=optimoss+puntosOptimos;   
                                 } 
                                 totalObtenido += puntosObtenidos; 
                                 totalOptimo += puntosOptimos;  
                                 resta=totalOptimo-optimoss;  
                                 if(totalOptimo > 0){
                                     porcentajeExito=((double) totalObtenido / (double) resta) * 100;
                                 } 
                                ...
                                if(Indicador.equals("Porcentaje de ordenes abiertas mayores a 30 dias") && incurridoCuatrimestre==0 || 
                                    Indicador.equals("Porcentaje de ordenes abiertas mayores a 30 dias") && incurridoCuatrimestre==0){
                                    optimoss2=optimoss2+puntosOptimos;  
                                    }else if(Indicador.equals("Porcentaje de ordenes abiertas mayores a 30 dias") && incurridoCuatrimestre==0 || 
Indicador.equals("Porcentaje de ordenes abiertas mayores a 30 dias") && incurridoCuatrimestre==0){
                                       optimoss2=optimoss2+puntosOptimos;   
                                    } else if(Indicador.equals("Índice de Satisfacción del Personal") && incurridoCuatrimestre==0 || 
Indicador.equals("Indice de Satisfaccion de Empleados ") && incurridoCuatrimestre==0){
                                        optimoss2=optimoss2+puntosOptimos; 
                                    }
                                 totalObtenido2 += puntosObtenidos; 
                                 totalOptimo2 += puntosOptimos;
                                 resta2=totalOptimo2-optimoss2;   
                                 if(totalOptimo2 > 0){
                                     porcentajeExito2=((double) totalObtenido2 / (double) resta2) * 100;
                                 }
                                 ...
                                 double incurridoCuatrimestre=arrayBalance.get(i).getBal_IncCuatrimestre();
                                 double incurridoAcumulado=arrayBalance.get(i).getBal_IncAcumulado(); 
                                 if (Indicador.equals("Poscicion en Ranking Nacional de Ventas Menudeo ") && incurridoCuatrimestre==0 || 
Indicador.equals("Poscicion en Ranking Nacional de Ventas Menudeo ") && incurridoAcumulado==0){
                                     optimoss3=optimoss3+puntosOptimos; 
                                 }else if (Indicador.equals("Posicion en Ranking Nacional de Ventas Menudeo Alfa") && incurridoCuatrimestre==0 || 
Indicador.equals("Posicion en Ranking Nacional de Ventas Menudeo Alfa") && incurridoAcumulado==0){
                                      optimoss3=optimoss3+puntosOptimos; 
                                 }else if(Indicador.equals("Posicion en Ranking Nacional de Ventas Menudeo + Flotilla Normal") && incurridoCuatrimestre==0 || 
Indicador.equals("Posicion en Ranking Nacional de Ventas Menudeo + Flotilla Normal") && incurridoAcumulado==0){ 
                                     optimoss3=optimoss3+puntosOptimos; 
                                 }else if(Indicador.equals("Unidades demostradoras vencidas") && incurridoCuatrimestre==0 || 
Indicador.equals("Unidades demostradoras vencidas") && incurridoCuatrimestre==0){  
                                     optimoss3=optimoss3+puntosOptimos; 
                                 }else if(Indicador.equals("SSI") && incurridoCuatrimestre==0 || Indicador.equals("SSI") && incurridoAcumulado==0){ 
                                     optimoss3=optimoss3+puntosOptimos;
                                 } else if(Indicador.equals("CSI") && incurridoCuatrimestre==0 || Indicador.equals("CSI") && incurridoAcumulado==0 || Indicador.equals("CSI ") && incurridoCuatrimestre==0 || Indicador.equals("CSI ") && incurridoAcumulado==0){ 
                                     optimoss3=optimoss3+puntosOptimos;
                                 }else if(Indicador.equals("SSI Alfa") && incurridoCuatrimestre==0 || Indicador.equals("SSI Alfa") && incurridoAcumulado==0){ 
                                     optimoss3=optimoss3+puntosOptimos;
                                }else if(Indicador.equals("Cumplimiento objetivo mensual de ventas planta") && incurridoCuatrimestre==0 ){
                                    optimoss3=optimoss3+puntosOptimos;
                                }else if(Indicador.equals("Cumplimiento objetivo mensual de ventas TMEX") && incurridoCuatrimestre==0){
                                    optimoss3=optimoss3+puntosOptimos;
                                }else if(Indicador.equals("Cumplimiento al programa cuatrimestral de capacitación") && incurridoCuatrimestre==0 || 
	Indicador.equals("Cumplimiento al programa cuatrimestral de capacitacion") && incurridoCuatrimestre==0){ 
                                        optimoss3=optimoss3+puntosOptimos;
                                        ...
                                        optimoss3=optimoss3+puntosOptimos;
                                }else if(Indicador.equals("Indice de Satisfaccion de Empleados ") && incurridoCuatrimestre==0 || 
	Indicador.equals("Índice de Satisfacción del Personal") && incurridoCuatrimestre==0 || 
	Indicador.equals("Indice de Satisfacción de Empleados ") && incurridoCuatrimestre==0 || 
	Indicador.equals("Indice de Satisfaccion de Empleados") && incurridoCuatrimestre==0){
                                            optimoss3=optimoss3+puntosOptimos;
                                    } 
                                 ...
                                 resta3=totalOptimo3-optimoss3; 
                                 if(totalOptimo3 > 0){
                                     porcentajeExito3=((double) totalObtenido3 / (double) resta3) * 100;
                                 }
                                 ...
                                 if (Indicador.equals("Posicion en Ranking Nacional de Ventas Menudeo") && incurridoCuatrimestre==0 || 
		Indicador.equals("Posicion en Ranking Nacional de Ventas Menudeo") && incurridoAcumulado==0){ 
                                      optimoss4=optimoss4+puntosOptimos;
                                 }
      ...
      optimoss4=optimoss4+puntosOptimos;
                                 ...
                                 else if(Indicador.equals("Cumplimiento al programa cuatrimestral de capacitacion") && incurridoCuatrimestre==0){
      optimoss4=optimoss4+puntosOptimos;
  }
                                 else if(Indicador.equals("Indice de Satisfaccion de Empleados ") && incurridoCuatrimestre==0){
      optimoss4=optimoss4+puntosOptimos; 
                                 ...
                                 resta4=totalOptimo4-optimoss4; 
                                 if(totalOptimo4 > 0){
                                     porcentajeExito4=((double) totalObtenido4 / (double) resta4) * 100;
                                 }
                                 ...
                                 double incurridoAcumulado=arrayBalance.get(i).getBal_IncAcumulado(); 
                                  ...
                                  if (Indicador.equals("Posicion en Ranking Nacional de Ventas Flotillas") && incurridoCuatrimestre==0 || 
		Indicador.equals("Posicion en Ranking Nacional de Ventas Flotillas") && incurridoAcumulado==0){ 
                                       optimoss5=optimoss5+puntosOptimos; 
                                  }
                                 totalObtenido5 += puntosObtenidos;
                                 totalOptimo5 += puntosOptimos;
                                 resta5=totalOptimo5-optimoss5; 
                                 if(totalOptimo5 > 0){
                                     porcentajeExito5=((double) totalObtenido5 / (double) resta5) * 100;
                                 } 
                             }if (idDepartamento.equals("BAL_DE006")){ 
                                 String Indicador=arrayBalance.get(i).getBal_Indicador();  
                                    double incurridoCuatrimestre=arrayBalance.get(i).getBal_IncCuatrimestre();
                                    double incurridoAcumulado=arrayBalance.get(i).getBal_IncAcumulado(); 
                                    if(Indicador.equals("Penetracion TFS") && incurridoCuatrimestre==0 || 
Indicador.equals("Penetracion TFS") && incurridoAcumulado==0){
                                        optimoss6=optimoss6+puntosOptimos; 
                                    } 
                                 totalObtenido6 += puntosObtenidos;
                                 totalOptimo6 += puntosOptimos;  
                                 resta6=totalOptimo6-optimoss6; 
                                 if(totalOptimo6 > 0){
                                     porcentajeExito6=((double) totalObtenido6 / (double) resta6) * 100;
                                 }
                                ...
                                if(Indicador.equals("ComPosicion del inventario (Obsoleto)") && incurridoCuatrimestre==0 || 
Indicador.equals("Composicion del inventario (Obsoleto)") && incurridoCuatrimestre==0 || 
Indicador.equals("Composicion del inventario") && incurridoCuatrimestre==0 || Indicador.equals("ComPosicion del inventario") && incurridoCuatrimestre==0){
                                    optimoss7=optimoss7+puntosOptimos;
                                }
                                else if(Indicador.equals("Calificación DSC Planta") && incurridoCuatrimestre==0){
            optimoss7=optimoss7+puntosOptimos;
}
...
Indicador.equals("Indice de Satisfaccion de Empleados") && incurridoCuatrimestre==0){ 
            optimoss7=optimoss7+puntosOptimos;
                                 ...
                                 resta7=totalOptimo7-optimoss7; 
                                 if(totalOptimo7 > 0){
                                     porcentajeExito7=((double) totalObtenido7 / (double) resta7) * 100;
                                 }
                             }if (idDepartamento.equals("BAL_DE008")){ 
                                String Indicador=arrayBalance.get(i).getBal_Indicador();  
                                double incurridoCuatrimestre=arrayBalance.get(i).getBal_IncCuatrimestre();
                                double incurridoAcumulado=arrayBalance.get(i).getBal_IncAcumulado(); 
                                if(Indicador.equals("Entrega Oportuna de Estados Financieros y MDUAS") && incurridoCuatrimestre==0 || 
Indicador.equals("Entrega Oportuna de Estados Financieros") && incurridoCuatrimestre==0){
                                    optimoss8=optimoss8+puntosOptimos;
                                }

if(Indicador.equals("Cumplimiento de Obligaciones Fiscales") && incurridoCuatrimestre==0){
                                    optimoss8=optimoss8+puntosOptimos;
}  

if(Indicador.equals("Indice de Satisfaccion de Empleados ") && incurridoCuatrimestre==0 || 
Indicador.equals("Índice de Satisfacción del Personal") && incurridoCuatrimestre==0 || 
Indicador.equals("Indice de Satisfaccion de Empleados") && incurridoCuatrimestre==0 || 
Indicador.equals("Indice de Satisfacción de Empleados ") && incurridoCuatrimestre==0 || 
Indicador.equals("Satisfaccion de Colaboradores") && incurridoCuatrimestre==0 || 
Indicador.equals("Indice de Satisfaccion del Personal") && incurridoCuatrimestre==0){ 
                            optimoss8=optimoss8+puntosOptimos;
}

if(Indicador.equals("Calificación DSC Planta") && incurridoCuatrimestre==0){ 
                            optimoss8=optimoss8+puntosOptimos;
}
                                 totalObtenido8 += puntosObtenidos;
                                 totalOptimo8 += puntosOptimos;
                                 resta8=totalOptimo8-optimoss8; 
                                 if(totalOptimo8 > 0){
                                     porcentajeExito8=((double) totalObtenido8 / (double) resta8) * 100;
                                 }
                        ...
                        totalesOP=resta+resta2+resta3+resta4+resta5+resta6+resta7+resta8;
        ...
        %>  
                        <td align="CENTER" style="border: black 1px solid; font-family: Calibri"><font color="black" size="2"><%=(int) resta%></td></font>
                        <td align="CENTER" style="border: black 1px solid; font-family: Calibri"><font color="black" size="2"><%=(int) resta2%></td></font>
                        <td align="CENTER" style="border: black 1px solid; font-family: Calibri"><font color="black" size="2"><%=(int) resta3%></td></font>
                        <td align="CENTER" style="border: black 1px solid; font-family: Calibri"><font color="black" size="2"><%=(int) resta4%></td></font>
                        <td align="CENTER" style="border: black 1px solid; font-family: Calibri"><font color="black" size="2"><%=(int) resta5%></td></font>
                        <td align="CENTER" style="border: black 1px solid; font-family: Calibri"><font color="black" size="2"><%=(int) resta6%></td></font>
                        <td align="CENTER" style="border: black 1px solid; font-family: Calibri"><font color="black" size="2"><%=(int) resta7%></td></font>
                        <td align="CENTER" style="border: black 1px solid; font-family: Calibri"><font color="black" size="2"><%=(int) resta8%></td></font>
                    ...
                    <tr>
                       ...
                       <% }else if(medida.equals("%")){%> 
                        ...
                        <% if(cumplimientoAcumulado >= 100.0){  
                                if(Indicador.equals("CSI") && incurridoCuatrimestre==0 || Indicador.equals("CSI") && incurridoAcumulado==0){ Poptimos= Poptimos+puntosOptimos;
                        %>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                        
                        <%} else if(Indicador.equals("FFV") && incurridoCuatrimestre==0 || Indicador.equals("FFV") && incurridoAcumulado==0){ Poptimos= Poptimos+puntosOptimos;%>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                        
                        <%}else if(Indicador.equals("SSI") && incurridoCuatrimestre==0 || Indicador.equals("SSI") && incurridoAcumulado==0){ Poptimos= Poptimos+puntosOptimos;%>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                        
                        <%}else if(Indicador.equals("Cumplimiento al programa cuatrimestral de capacitación") && incurridoCuatrimestre==0 || 
	Indicador.equals("Cumplimiento al programa cuatrimestral de capacitacion") && incurridoCuatrimestre==0){ Poptimos= Poptimos+puntosOptimos;%>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                        
                        <%}else if(Indicador.equals("Calificación DSC Planta") && incurridoCuatrimestre==0){ Poptimos= Poptimos+puntosOptimos; %>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                        
                        <%}else if(Indicador.equals("Indice de Satisfaccion de Empleados ") && incurridoCuatrimestre==0 || 
	Indicador.equals("Índice de Satisfacción del Personal") && incurridoCuatrimestre==0 || 
	Indicador.equals("Indice de Satisfaccion de Empleados") && incurridoCuatrimestre==0){ Poptimos= Poptimos+puntosOptimos;%>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                        ...
                        <%} }if (cumplimientoAcumulado < 100.0 && cumplimientoAcumulado >= 85.0) { 
                                if(Indicador.equals("CSI") && incurridoCuatrimestre==0 || Indicador.equals("CSI") && incurridoAcumulado==0 || Indicador.equals("CSI ") && incurridoCuatrimestre==0 || Indicador.equals("CSI ") && incurridoAcumulado==0){ Poptimos= Poptimos+puntosOptimos;
                        %>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
	...
	Indicador.equals("Indice de Satisfaccion de Empleados") && incurridoCuatrimestre==0){ Poptimos= Poptimos+puntosOptimos;%>
                        ...
                        <%} }if (cumplimientoAcumulado < 85.0) {  
                                if(Indicador.equals("CSI") && incurridoCuatrimestre==0 || Indicador.equals("CSI") && incurridoAcumulado==0 || Indicador.equals("CSI ") && incurridoCuatrimestre==0 || Indicador.equals("CSI ") && incurridoAcumulado==0){ 
                                Poptimos= Poptimos+puntosOptimos;  
                        %>
                         <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                         <%   } else if(Indicador.equals("FFV") && incurridoCuatrimestre==0 || Indicador.equals("FFV") && incurridoAcumulado==0 || Indicador.equals("FFV ") && incurridoCuatrimestre==0 || Indicador.equals("FFV ") && incurridoAcumulado==0){ 
                                Poptimos= Poptimos+puntosOptimos; 
                         ...
                         %>
                          ...
                          <%}else if(Indicador.equals("Cumplimiento al programa cuatrimestral de capacitación") && incurridoCuatrimestre==0 || Indicador.equals("Cumplimiento al programa cuatrimestral de capacitacion") && incurridoCuatrimestre==0){  
                            Poptimos= Poptimos+puntosOptimos; 
                           %>  
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                        ...
                        <%}else{   %>
                        <td bgcolor="red" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><a href="" style="text-decoration:none; color: white;"><%=(int) puntosObtenidos%></font></a></td>
                       <% }}%>
                ...
                <%} } }%> 
                 <tr> 
                    ...
                    <%
                        totalOptimo=totalOptimo-Poptimos;  
                    %>
                ...
                %> 
                    <tr>
                       ...
                       <% }else if(Indicador.equals("SSI")){ %>
                        ...
                        <%}}%>
                        <% if(cumplimientoAcumulado >= 100.0){  
                        if(Indicador.equals("Porcentaje de ordenes abiertas mayores a 30 dias") && incurridoCuatrimestre==0 || Indicador.equals("Porcentaje de ordenes abiertas mayores a 30 dias") && incurridoCuatrimestre==0){ 
                                PoptimosH= PoptimosH+puntosOptimos;     
                        %>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                        <%}else if(Indicador.equals("Índice de Satisfacción del Personal") && incurridoCuatrimestre==0 || 
Indicador.equals("Indice de Satisfaccion de Empleados ") && incurridoCuatrimestre==0){ PoptimosH= PoptimosH+puntosOptimos; %>
                         <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                        ...
                        <%} }if (cumplimientoAcumulado < 100.0 && cumplimientoAcumulado >= 85.0) {  
                                    if(Indicador.equals("Porcentaje de ordenes abiertas mayores a 30 dias") && incurridoCuatrimestre==0 || 
Indicador.equals("Porcentaje de ordenes abiertas mayores a 30 dias") && incurridoCuatrimestre==0){ PoptimosH= PoptimosH+puntosOptimos;
                            %>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
...
Indicador.equals("Indice de Satisfaccion de Empleados ") && incurridoCuatrimestre==0){ PoptimosH= PoptimosH+puntosOptimos;%>
                        ...
                        %>  
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                        <%} else if(Indicador.equals("Índice de Satisfacción del Personal") && incurridoCuatrimestre==0 || Indicador.equals("Indice de Satisfaccion de Empleados ") && incurridoCuatrimestre==0){ 
                                PoptimosH= PoptimosH+puntosOptimos;  %> 
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                ...
                <%  } } } %>
                 <tr>
                    ...
                    <td align="CENTER" style="font-family :Calibri; font-weight: bold; font-size: small; border: black 1px solid"><%=(int) totalObtenido2%></td>
                     <%
                        totalOptimo2=totalOptimo2-PoptimosH;   
                    %>
			...
			<td bgcolor="silver" width="100%" align="CENTER" style="font-family: Calibri; font-weight: bold; border: black 1px solid">
                ...
                %> 
                    <tr>
                        ...
                        <%}}%> 
                        <% if(cumplimientoAcumulado >= 100.0){ %>
                        <%if (Indicador.equals("Poscicion en Ranking Nacional de Ventas Menudeo ") && incurridoCuatrimestre==0 || Indicador.equals("Poscicion en Ranking Nacional de Ventas Menudeo ") && incurridoAcumulado==0){  
                                PoptimosVN= PoptimosVN+puntosOptimos; %>  
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                        
                        <%} else if (Indicador.equals("Posicion en Ranking Nacional de Ventas Menudeo Alfa") && incurridoCuatrimestre==0 || Indicador.equals("Posicion en Ranking Nacional de Ventas Menudeo Alfa") && incurridoAcumulado==0){ 
                                PoptimosVN= PoptimosVN+puntosOptimos;  
                         %>  
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                         
                        <%}else if(Indicador.equals("Posicion en Ranking Nacional de Ventas Menudeo + Flotilla Normal") && incurridoCuatrimestre==0 || Indicador.equals("Posicion en Ranking Nacional de Ventas Menudeo + Flotilla Normal") && incurridoAcumulado==0){ 
                            PoptimosVN= PoptimosVN+puntosOptimos;  
                        %>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                   
                       <% }else if(Indicador.equals("Unidades demostradoras vencidas") && incurridoCuatrimestre==0 || Indicador.equals("Unidades demostradoras vencidas") && incurridoCuatrimestre==0){  
                                PoptimosVN= PoptimosVN+puntosOptimos; %>
                       <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                       ...
                       <%}else if(Indicador.equals("Cumplimiento objetivo mensual de ventas planta") && incurridoCuatrimestre==0 ){ PoptimosVN= PoptimosVN+puntosOptimos;
                            %>
                       <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                   
                        <%}else if(Indicador.equals("Cumplimiento objetivo mensual de ventas TMEX") && incurridoCuatrimestre==0){ PoptimosVN= PoptimosVN+puntosOptimos;
                        %>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                   
                       <%}else if(Indicador.equals("Cumplimiento al programa cuatrimestral de capacitación") && incurridoCuatrimestre==0 || 
Indicador.equals("Cumplimiento al programa cuatrimestral de capacitacion") && incurridoCuatrimestre==0){ PoptimosVN= PoptimosVN+puntosOptimos;%>
                       <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                   
                        <%}else if(Indicador.equals("Calificación DSC Planta") && incurridoCuatrimestre==0){ PoptimosVN= PoptimosVN+puntosOptimos;%>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                   
                       <%}else if(Indicador.equals("Indice de Satisfaccion de Empleados ") && incurridoCuatrimestre==0 || 
Indicador.equals("Índice de Satisfacción del Personal") && incurridoCuatrimestre==0 || 
Indicador.equals("Indice de Satisfacción de Empleados ") && incurridoCuatrimestre==0 || 
Indicador.equals("Indice de Satisfaccion de Empleados") && incurridoCuatrimestre==0){ PoptimosVN= PoptimosVN+puntosOptimos;%>
                       <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                    
                        <%}else{%>     
                        <td bgcolor="green" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                        <% } }if (cumplimientoAcumulado < 100.0 && cumplimientoAcumulado >= 85.0) {  
                                if(Indicador.equals("Unidades demostradoras vencidas") && incurridoCuatrimestre==0 || Indicador.equals("Unidades demostradoras vencidas") && incurridoCuatrimestre==0){  
                                PoptimosVN= PoptimosVN+puntosOptimos;
                        %>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                        
                        <%} else if (Indicador.equals("Poscicion en Ranking Nacional de Ventas Menudeo ") && incurridoCuatrimestre==0 || Indicador.equals("Poscicion en Ranking Nacional de Ventas Menudeo ") && incurridoAcumulado==0){  
                                PoptimosVN= PoptimosVN+puntosOptimos;%>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
...
Indicador.equals("Indice de Satisfaccion de Empleados") && incurridoCuatrimestre==0){ PoptimosVN= PoptimosVN+puntosOptimos;%>
                        ...
                        <td bgcolor="yellow" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font size="2"><%=(int) puntosObtenidos%></font></td>
                        <% } }if (cumplimientoAcumulado < 85.0) { 
                                if(Indicador.equals("SSI") && incurridoCuatrimestre==0 || Indicador.equals("SSI") && incurridoAcumulado==0){ 
                                PoptimosVN= PoptimosVN+puntosOptimos; %>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                       ...
                       <%} else if(Indicador.equals("SSI Alfa") && incurridoCuatrimestre==0 || Indicador.equals("SSI Alfa") && incurridoAcumulado==0){ 
                        ...
                        <%} else if(Indicador.equals("Cumplimiento al programa cuatrimestral de capacitación") && incurridoCuatrimestre==0 || Indicador.equals("Cumplimiento al programa cuatrimestral de capacitacion") && incurridoCuatrimestre==0){ PoptimosVN= PoptimosVN+puntosOptimos;%>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                        
                        <%} else if(Indicador.equals("Calificación DSC Planta") && incurridoCuatrimestre==0){ PoptimosVN= PoptimosVN+puntosOptimos;%>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                         
                        <%} else if(Indicador.equals("Indice de Satisfaccion de Empleados ") && incurridoCuatrimestre==0 || Indicador.equals("Índice de Satisfacción del Personal") && incurridoCuatrimestre==0 || Indicador.equals("Indice de Satisfacción de Empleados ") && incurridoCuatrimestre==0 || Indicador.equals("Indice de Satisfaccion de Empleados") && incurridoCuatrimestre==0){ PoptimosVN= PoptimosVN+puntosOptimos;%> 
                         <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                ...
                <% } } } %>
                 <tr>
                    ...
                    <% totalOptimo3=totalOptimo3-PoptimosVN;
                    %>
                ...
                %> 
                    <tr>
                       ...
                       <td align="CENTER" style="font-family :Calibri; font-size: small; border: black 1px solid"><%=df.format(objAnual * 100)+medida%></td>
                        ...
                        <%}}%>
                        <% if(cumplimientoAcumulado >= 100.0){ 
                                if (Indicador.equals("Posicion en Ranking Nacional de Ventas Menudeo") && incurridoCuatrimestre==0 || Indicador.equals("Posicion en Ranking Nacional de Ventas Menudeo") && incurridoAcumulado==0){ 
                                PoptimosVS= PoptimosVS+puntosOptimos; %>  
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                        <%}else if(Indicador.equals("SSI") && incurridoCuatrimestre==0 || Indicador.equals("SSI") && incurridoAcumulado==0){   
                                PoptimosVS= PoptimosVS+puntosOptimos;%>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                        
                        <%} else if(Indicador.equals("Unidades demostradoras vencidas") && incurridoCuatrimestre==0){ PoptimosVS= PoptimosVS+puntosOptimos;%>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
...
PoptimosVS= PoptimosVS+puntosOptimos;%>
	...
	Indicador.equals("Posicion en Ranking Nacional de Ventas Menudeo") && incurridoAcumulado==0){ 
		...
		PoptimosVS= PoptimosVS+puntosOptimos;%>
                        ...
                        <%}else if(Indicador.equals("Cumplimiento objetivo mensual de ventas planta") && incurridoCuatrimestre==0){ PoptimosVS= PoptimosVS+puntosOptimos;%>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                        ...
                        <%} else if(Indicador.equals("Indice de Satisfaccion de Empleados ") && incurridoCuatrimestre==0){ PoptimosVS= PoptimosVS+puntosOptimos;%>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                        
                        <%}else if (Indicador.equals("Posicion en Ranking Nacional de Ventas Menudeo") && incurridoCuatrimestre==0 || 
	Indicador.equals("Posicion en Ranking Nacional de Ventas Menudeo") && incurridoAcumulado==0){ 
                                PoptimosVS= PoptimosVS+puntosOptimos;%>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                ...
                <% } } }  %>
                 <tr>
                    ...
                    <%totalOptimo4=totalOptimo4-PoptimosVS;%>
			...
			<td bgcolor="silver" width="100%" align="CENTER" style="font-family: Calibri; font-weight: bold; border: black 1px solid">
                ...
                %> 
                    <tr>
                       ...
                       <%} else if(Indicador.equals("SSI")){ %>
                        ...
                        <%}}%>
                        <%  if(cumplimientoAcumulado >= 100.0){  
                                if (Indicador.equals("Posicion en Ranking Nacional de Ventas Flotillas") && incurridoCuatrimestre==0 || Indicador.equals("Posicion en Ranking Nacional de Ventas Flotillas") && incurridoAcumulado==0){ 
                                PoptimosVF= PoptimosVF+puntosOptimos; 
                     %>  
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                ...
                <%  } } }  %>
                 <tr>
                    ...
                    <%totalOptimo5=totalOptimo5-PoptimosVF;%>
                    ...
                    <tr>
                       ...
                       <%} else if(medida.equals("%")){  %>
                        ...
                        <%  if(cumplimientoAcumulado >= 100.0){    
                            if(Indicador.equals("Penetracion TFS") && incurridoCuatrimestre==0 || 
	Indicador.equals("Penetracion TFS") && incurridoAcumulado==0){
                        PoptimosFI= PoptimosFI+puntosOptimos;  
                        %>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
	...
	Indicador.equals("Penetracion TFS") && incurridoAcumulado==0){
                        ...
                        <td bgcolor="yellow" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font size="2"><%=(int) puntosObtenidos%></font></td>
                        <%} }if (cumplimientoAcumulado < 85.0) { 
                           if(Indicador.equals("")){ //Penetracion VACH
                           PoptimosFI= PoptimosFI+puntosOptimos; %>  
                       <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                        <% } else if(Indicador.equals("a")){ // Penetracion en Venta de Contratos de Servicio
                            PoptimosFI= PoptimosFI+puntosOptimos;  
                        %>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                       
                        <%}else if(Indicador.equals("Penetracion TFS") && incurridoCuatrimestre==0 || Indicador.equals("Penetracion TFS") && incurridoAcumulado==0){
                        PoptimosFI= PoptimosFI+puntosOptimos;  
                        %>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                       
                        <%} else if(Indicador.equals("b")){ //Penetracion VACH Alfa  
                        PoptimosFI= PoptimosFI+puntosOptimos;    
                       %>  
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                       
                        <% }else if(Indicador.equals("c")){ //Penetracion en Venta de Contratos de Servicio Alfa
                        PoptimosFI= PoptimosFI+puntosOptimos;  
                        %> 
                       <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                ...
                <% }  }  }   %>
                 <tr>
                    ...
                    <%totalOptimo6=totalOptimo6-PoptimosFI;%> 
                       ...
                       <% }if (medida.equals("")) {       
                        ...
                        <% if(cumplimientoAcumulado >= 100.0){  
                            if(Indicador.equals("ComPosicion del inventario (Obsoleto)") && incurridoCuatrimestre==0 ||  
                                    Indicador.equals("Composicion del inventario (Obsoleto)") && incurridoCuatrimestre==0 || 
                                    Indicador.equals("Composicion del inventario") && incurridoCuatrimestre==0 || Indicador.equals("ComPosicion del inventario") && incurridoCuatrimestre==0){
                        PoptimosR= PoptimosR+puntosOptimos;      
                        %>
                       <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                        
                        <%}else if(Indicador.equals("Calificación DSC Planta") && incurridoCuatrimestre==0){ PoptimosR= PoptimosR+puntosOptimos;%>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                         
                       <%}else if(Indicador.equals("Indice de Satisfaccion de Empleados ") && incurridoCuatrimestre==0 || 
Indicador.equals("Índice de Satisfacción del Personal") && incurridoCuatrimestre==0 || 
Indicador.equals("Indice de Satisfaccion de Empleados") && incurridoCuatrimestre==0){ PoptimosR= PoptimosR+puntosOptimos;%>
                       <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
...
Indicador.equals("Indice de Satisfaccion de Empleados") && incurridoCuatrimestre==0){ PoptimosR= PoptimosR+puntosOptimos;%>
                        ...
                        <td bgcolor="yellow" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font size="2"><%=(int) puntosObtenidos%></font></td>
                        <%} }if (cumplimientoAcumulado < 85.0) {   
                            if(Indicador.equals("")){ //Penetracion VACH Mitsu 
                            PoptimosR= PoptimosR+puntosOptimos;  
                        %> 
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                        
                        <%}else if(Indicador.equals("a")){ //Penetracion en Venta de Contratos de Servicio Mitsu
                        PoptimosR= PoptimosR+puntosOptimos; 
                        %> 
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                        ...
                        <%} else if(Indicador.equals("Indice de Satisfaccion de Empleados ") && incurridoCuatrimestre==0 || Indicador.equals("Índice de Satisfacción del Personal") && incurridoCuatrimestre==0 || Indicador.equals("Indice de Satisfaccion de Empleados") && incurridoCuatrimestre==0){ PoptimosR= PoptimosR+puntosOptimos;%>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                         
                        <%}else if(Indicador.equals("ComPosicion del inventario (Obsoleto)") && incurridoCuatrimestre==0 || 
Indicador.equals("Composicion del inventario (Obsoleto)") && incurridoCuatrimestre==0 || 
Indicador.equals("Composicion del inventario") && incurridoCuatrimestre==0 || Indicador.equals("ComPosicion del inventario") && incurridoCuatrimestre==0){
                        PoptimosR= PoptimosR+puntosOptimos; %>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                ...
                <%   } } } %>
                 <tr>
                    ...
                    <%totalOptimo7=totalOptimo7-PoptimosR;%>
                ...
                %> 
                    <tr>
                       ...
                       <% } else if(medida.equals("%")){  %>
                        ...
                        <%}}%>
                        <% if(cumplimientoAcumulado >= 100.0){ 
                            if(Indicador.equals("Entrega Oportuna de Estados Financieros y MDUAS") && incurridoCuatrimestre==0 || Indicador.equals("Entrega Oportuna de Estados Financieros") && incurridoCuatrimestre==0){
                                PoptimosAYF= PoptimosAYF+puntosOptimos; 
                        %>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                       
                        <%} else if(Indicador.equals("Cumplimiento de Obligaciones Fiscales") && incurridoCuatrimestre==0){   PoptimosAYF= PoptimosAYF+puntosOptimos; %>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
...
Indicador.equals("Indice de Satisfacción de Empleados ") && incurridoCuatrimestre==0 || 
Indicador.equals("Satisfaccion de Colaboradores") && incurridoCuatrimestre==0 || 
Indicador.equals("Indice de Satisfaccion del Personal") && incurridoCuatrimestre==0){ PoptimosAYF= PoptimosAYF+puntosOptimos; %>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                       
                        <%} else if(Indicador.equals("Calificación DSC Planta") && incurridoCuatrimestre==0){ PoptimosAYF= PoptimosAYF+puntosOptimos; %>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
                        ...
                        <% } }if (cumplimientoAcumulado < 100.0 && cumplimientoAcumulado >= 85.0) { 
                                if(Indicador.equals("Entrega Oportuna de Estados Financieros y MDUAS") && incurridoCuatrimestre==0 || 
Indicador.equals("Entrega Oportuna de Estados Financieros") && incurridoCuatrimestre==0){ PoptimosAYF= PoptimosAYF+puntosOptimos; 
                        %>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>
...
Indicador.equals("Indice de Satisfaccion del Personal") && incurridoCuatrimestre==0){ PoptimosAYF= PoptimosAYF+puntosOptimos; %>
                        ...
                        <%} else if(Indicador.equals("Indice de Satisfaccion de Empleados ") && incurridoCuatrimestre==0 || Indicador.equals("Índice de Satisfacción del Personal") && incurridoCuatrimestre==0 || Indicador.equals("Indice de Satisfaccion de Empleados") && incurridoCuatrimestre==0 || Indicador.equals("Indice de Satisfacción de Empleados ") && incurridoCuatrimestre==0 || Indicador.equals("Satisfaccion de Colaboradores") && incurridoCuatrimestre==0 || Indicador.equals("Indice de Satisfaccion del Personal") && incurridoCuatrimestre==0){ PoptimosAYF= PoptimosAYF+puntosOptimos;%>
                        <td bgcolor="black" align="CENTER" style="font-family: Calibri; border: black 1px solid;"><font color="white" size="2"><%=(int) puntosObtenidos%></font></td>

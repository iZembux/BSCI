<%-- 
    Document   : actualizarIncurridosCap
    Created on : 29/01/2018, 02:32:01 PM
    Author     : Guadalupe
--%>
...
<%
    ...
    try {
        acumulado = Double.parseDouble(request.getParameter("Acumulado"));
    ...
    switch (accion) {
        ...
        case 2:
            ...
            ok = objIncurridos.actualizarIncurridoCapXMes(identificaIndicador, anio, unidadNegocio, mes, valorMes, acumulado, usuario, fechaActual);
